var supplier = {
    list: function () {
        tblSupplier = $('#zero-config').DataTable({
            responsive: true,
            autoWidth: false,
            destroy: true,
            deferRender: true,
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        htm += '<a href="/inv/supplier/update/' + row.id + '/" rel="edit" class="btn btn-dark btn-sm">Editar</a>';
                        ...
                        htm += '<a class="dropdown-item" href="/inv/supplier/delete/' + row.id + '/" rel="Eliminar"' + row.id + '/">Eliminar</a>';
                        htm += '</div>';
                        htm += '</div>';
                        return htm;
