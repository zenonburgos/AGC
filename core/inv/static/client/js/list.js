            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        htm += '<a href="/inv/client/update/' + row.id + '/" rel="edit" class="btn btn-dark btn-sm">Editar</a>';
                        ...
                        htm += '<a class="dropdown-item" href="/inv/client/delete/' + row.id + '/" rel="Eliminar"' + row.id + '/">Eliminar</a>';
                        htm += '</div>';
                        htm += '</div>';
                        return htm;
