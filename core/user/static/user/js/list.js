        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    return '<img src="'+row.image+'" class="img-fluid rounded-circle" style="width: 20px; height: 20px;">';
                }
            },
            {
                targets: [-2],
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    htm='<div class="btn-group">';
                        htm+='<a href="/user/update/' + row.id + '/" class="btn btn-dark btn-sm">Editar</a>';
                        ...
                        htm+='<a class="dropdown-item" href="/user/delete/' + row.id + '/">Eliminar</a>';
                        htm+='</div>';
                    htm+='</div>';
                    return htm;
